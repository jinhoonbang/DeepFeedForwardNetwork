...
class SoftMax(object):
    ...
    def negative_log_likelihood(self, y):
        ...
        m3 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,2]+6])
        m4 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,3]+9])
        m5 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,4]+12])
        m6 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,5]+15])
        m7 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,6]+18])
        m8 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,7]+21])
        m9 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,8]+24])
        m10 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,9]+27])
        m11 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,10]+30])
        m12 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,11]+33])
        m13 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,12]+36])
        m14 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,13]+39])
        m15 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,14]+42])
        m16 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,15]+45])
        m17 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,16]+48])
        m18 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,17]+51])
        m19 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,18]+54])
        m20 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,19]+57])
        m21 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,20]+60])
        m22 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,21]+63])
        m23 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,22]+66])
        m24 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,23]+69])
        m25 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,24]+72])
        m26 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,25]+75])
        m27 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,26]+78])
        m28 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,27]+81])
        m29 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,28]+84])
        m30 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,29]+87])
        m31 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,30]+90])
        m32 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,31]+93])
        m33 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,32]+96])
        m34 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,33]+99])
        m35 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,34]+102])
        m36 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,35]+105])
        m37 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,36]+108])
        m38 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,37]+111])
        m39 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,38]+114])
        m40 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,39]+117])
        m41 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,40]+120])
        m42 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,41]+123])
        m43 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,42]+126])
