...
class SoftMax(object):
    ...
    def negative_log_likelihood(self, y):
        ...
        m1 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,0]])
        m2 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,1]])
        m3 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,2]])
        m4 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,3]])
        m5 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,4]])
        m6 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,5]])
        m7 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,6]])
        m8 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,7]])
        m9 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,8]])
        m10 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,9]])
        m11 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,10]])
        m12 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,11]])
        m13 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,12]])
        m14 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,13]])
        m15 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,14]])
        m16 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,15]])
        m17 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,16]])
        m18 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,17]])
        m19 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,18]])
        m20 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,19]])
        m21 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,20]])
        m22 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,21]])
        m23 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,22]])
        m24 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,23]])
        m25 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,24]])
        m26 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,25]])
        m27 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,26]])
        m28 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,27]])
        m29 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,28]])
        m30 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,29]])
        m31 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,30]])
        m32 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,31]])
        m33 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,32]])
        m34 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,33]])
        m35 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,34]])
        m36 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,35]])
        m37 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,36]])
        m38 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,37]])
        m39 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,38]])
        m40 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,39]])
        m41 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,40]])
        m42 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,41]])
        m43 = -T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y[:,42]])
